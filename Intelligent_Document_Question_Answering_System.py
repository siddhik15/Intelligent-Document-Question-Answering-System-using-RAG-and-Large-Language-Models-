...
st.markdown(
    '<div class="main-title">Intelligent Document Question Answering System using RAG and Large Language Models</div>',
    unsafe_allow_html=True
)
...
<div class="footer">
<hr>
Implemented During AI/ML Training | Siddhi | Date: 01/06/2026
</div>
""", unsafe_allow_html=True)